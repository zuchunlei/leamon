...
public class Downloader {
	...
	public void download(String srcFilePath, String destFilePath) {
		try {
			...
			for (int i = 0; i < part; i++) {
				...
				DownLoadTask task = new DownLoadTask(index, end, new File(
						srcFilePath), new File(destFilePath), latch);
	...
	static class DownLoadTask implements Runnable {
		...
		public DownLoadTask(long start, long end, File src, File dest,
